...
The front end consists of a modern web-application using a design created with the design principles for good user experience as described by \citeasnoun{Sharp2007a} in mind.
